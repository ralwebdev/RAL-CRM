      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="rounded-xl bg-card p-4 shadow-card">
          ...
          <div className="space-y-1.5 text-xs text-muted-foreground">
            ...
            <div className="flex justify-between"><span>Alliance Exe</span><span className="font-mono text-card-foreground">sneha@redapple.com / alliance123</span></div>
            ...
            <div className="flex justify-between"><span>Alliance Exe</span><span className="font-mono text-card-foreground">arjun@redapple.com / accounts123</span></div>
          </div>
        </div>
      </div>
    </div>
